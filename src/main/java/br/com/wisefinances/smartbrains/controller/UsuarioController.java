...
public class UsuarioController {
    ...
    @PostMapping("/info")
    public ResponseEntity<UsuarioDTO> getUsuarioInfoByEmail(@RequestBody @Valid UserEmailDTO userEmailDTO) {
        return ResponseEntity.ok(usuarioService.findUsuarioInfoByEmail(userEmailDTO.getEmail()));
    }
